    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medico', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='entidad.medico')),
                ('paciente', models.ForeignKey(on_delete=ast.Delete, to='consulta.paciente')),
            ],
        ),
    ]
